...
// współrzędne wierzchołków 11 scianu

GLfloat vertex[12 * 3] =
{
	0.000,  1.367,  0.500,   // v0
	0.000,  1.267, -0.500,   // v1
	0.000, -0.667, -0.500,   // v2
	0.000, -1.167,  0.500,   // v3
	0.667,  1.500,  0.000,   // v4
	0.667, -0.500,  0.000,   // v5
	-0.667, -0.500,  0.000,  // v6
	-0.667,  0.500,  0.000,  // v7
	0.500,  1.000,  0.667,   // v8
	-0.500,  0.000,  0.667,  // v9
	-0.500,  0.000, -0.667,  // v10
	0.500,  1.000, -0.667    // v11
};
